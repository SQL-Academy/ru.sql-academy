...
Это означает, что рамка окна будет начинаться с первой строки и
заканчиваться текущей строкой, включая все строки с теми же значениями полей сортировки, что и у текущей строки.
...
Подробнее о рамках окон и их определении в следующей статье.
