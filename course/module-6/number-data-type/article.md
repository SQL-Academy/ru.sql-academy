---
meta:
    title: "Числовые типы данных в SQL: INT, DECIMAL, FLOAT — отличия"
    description: "Числовые типы данных SQL и их отличия: целые INT и BIGINT, точные DECIMAL и NUMERIC, приближённые FLOAT и DOUBLE. Какой тип выбрать для денег, счётчиков и измерений в MySQL и PostgreSQL."
---
