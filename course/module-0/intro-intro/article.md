...
Сертификат станет доступен после 50 самостоятельно решённых заданий в **<a href="https://sql-academy.org/trainer" target="_blank">Тренажёре</a>**. Задания, в которых вы посмотрели готовое решение, не учитываются.
