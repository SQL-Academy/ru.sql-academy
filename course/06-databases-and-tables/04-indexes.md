...
![Сравнение скорости поиска в таблице с индексом](https://sql-academy.org/static/guidePage/indexes/statistic_ru.png "Сравнение скорости поиска в таблице с индексом")
...
Когда таблица была создана, MySQL автоматически сгенерировала
...
PostgreSQL автоматически создаёт индекс для столбца первичного ключа, которым в данном случае является
...
1. Индексы увеличивают скорость всех операций в базе данных, включая вставку, обновление и удаление данных. — Хотя индексы действительно могут увеличить скорость выполнения запросов на чтение, они могут замедлить операции вставки, обновления и удаления данных, так как требуют дополнительного обновления индексных структур.
