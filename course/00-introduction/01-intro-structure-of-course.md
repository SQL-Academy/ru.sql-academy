...
Ассистент работает для **зарегистрированных пользователей**. У каждого пользователя есть несколько бесплатных запросов, а у <a href="https://sql-academy.org/ru/premium" target="_blank">премиум-пользователей</a> они безлимитные! 😊
