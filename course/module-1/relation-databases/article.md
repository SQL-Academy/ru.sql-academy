---
meta:
    title: "Реляционная база данных: что это такое простыми словами"
    description: "Что такое реляционная база данных: таблицы, строки и связи через ключи. Особенности реляционной модели, примеры и рейтинг популярных реляционных СУБД."
---
...
наш особый интерес при изучении SQL. Как именно устроены таблицы — записи, атрибуты, первичные и внешние ключи — мы подробно разбираем
в следующем уроке: [Структура реляционных баз данных](https://sql-academy.org/ru/guide/structure-of-relation-databases).
